...
describe('[Challenge] Side entrance', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackSideEntraceDeployer = await ethers.getContractFactory("AttackSideEntrance", attacker);
        const attackContract = await AttackSideEntraceDeployer.deploy(this.pool.address);
